...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
    ...
    <button type="submit" class="hover-link">Cancel Ticket</button>
</form>

<?php

if ($_SERVER["REQUEST_METHOD"] == "POST" && $ticketErr=="" && $emailErr=="" && $mobileErr=="") {
    echo "<h3 style='color:green; text-align:center;'>Ticket Cancellation Request Submitted!</h3>";
